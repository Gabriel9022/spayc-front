      ...
      <div className="Footer_section">
        <div className="Footer_firstSection_container">
          <div className="logo_container">
            ...
            <p>
              Servicios Profesionales de Apoyo y Cuidado para Personas Mayores
            </p>
          </div>
        </div>
        <div className="Footer_secondSection_container">
          <ul className="Footer_secondSection_ul">
            ...
            <li>
              <a
                href="https://wa.me/5493547571781?text=SPAYC%20leí%20los%20servicios%20en%20su%20página%20y%20quería%20consultar%20acerca%20de:"
                target="_blank"
            ...
            <li>
              <a
                href="mailto:spaycserviciosprofesionales@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
              >
                spaycserviciosprofesionales@gmail.com
              </a>
            </li>
          </ul>
          <div className="Footer_secondSection_socialMedia">
            <div className="socialMedia_container">
              <div className="socialMedia_icon_container">
                <a
                  className="Footer_socialmedia_link"
                ...
                >
                  <img
                    ...
                    src={facebook_circle_black_icon}
                    alt=""
                  />
                </a>
              </div>
              <div className="socialMedia_icon_container">
                <a
                  className="Footer_socialmedia_link"
                  href="https://www.instagram.com/spaycserviciospersonasmayores/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                    className="socialMedia_icon"
                    src={instagram_black_icon}
                    alt=""
                  />
                </a>
              </div>
