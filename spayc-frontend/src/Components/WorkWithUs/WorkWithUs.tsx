...
import WorkWithUsImage from '../../assets/images/WorkWithUs/trab1.webp';
      ...
      <div className='WorkWithUs_sections'>
        ...
        <section className='WorkWithUs_section_info'>
          <div className='WorkWithUs_info_container'>
            <div className='WorkWithUs_info'>
              ...
              <p className='WorkWithUs_info_description'>Si contás con conocimientos, experiencia en el rubro y un fuerte deseo de hacer una diferencia positiva en la vida de las personas mayores y sus familias, ¡CONTACTATE con nosotros y formá parte de nuestro equipo!</p>
            </div>
        ...
        <section className='WorkWithUs_section_form'>
          <div className='WorkWithUs_section_form_container'>
            <h2 className='WorkWithUs_form_title'>Si querés formar parte de SPAYC completá el siguiente formulario</h2>
