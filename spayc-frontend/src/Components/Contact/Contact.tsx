    ...
    <div className='Contact_component'>
      <div className='Contact_sections'>
        ...
        <section className='Contact_intro_section'>
          <p className='Contact_intro_description'>En SPAYC valoramos la comunicación directa y efectiva, si tenés alguna consulta o necesitás más información sobre nuestros servicios, no dudes en contactarnos y un asesor se comunicará.</p>
        </section>
        <section className='Contact_info_form_sections'>
          <div className='Contact_section_info'>
            ...
            <div className='Contact_info_container'>
              ...
              <p>Teléfono: <a href='tel:3515459115' target='_blank'><span>351 5459115</span></a></p>
